...
def get_sales_report(db: Session = Depends(get_db), admin: User = Depends(get_admin_user)):
...
def get_users_report(db: Session = Depends(get_db), admin: User = Depends(get_admin_user)):
...
def get_products_report(db: Session = Depends(get_db), admin: User = Depends(get_admin_user)):
